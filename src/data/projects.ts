...
export const projects: Project[] = [
  {
    ...
    summary: 'Strona producenta mebli na wymiar, która pokazuje wykonane meble i zbiera zapytania o wycenę.',
    context:
    ...
    stack: ['Strona firmowa', 'Wersja na telefon', 'SEO'],
    image: luxMeble,
    imageAlt: 'Strona główna Lux Meble: zdjęcie drewnianych schodów, nagłówek o precyzji rzemiosła i przycisk bezpłatnej wyceny',
    year: null,
    results: null,
  },
  {
  ...
  },
  {
    ...
    image: ezdrp24,
    imageAlt: 'Strona główna EZDRP24: nagłówek „EZD RP – zestawy dla jednostek publicznych” i ilustracja zestawu: komputer, skaner i drukarka etykiet',
    year: null,
    results: null,
  },
];
